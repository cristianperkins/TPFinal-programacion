...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_email'])) {
    ...
    # Si el ID del autor no está definido
    if (!isset($_GET['id'])) {
...
<body>
    <div class="container">
        ...
        <form action="php/func-editar-autor.php" method="post" class="shadow p-4 rounded mt-5" style="width: 90%; max-width: 50rem;">
