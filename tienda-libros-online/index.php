...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $query = "SELECT libros.id, libros.titulo, libros.descripcion, libros.portada, autor.nombre AS autor_nombre, autor.apellido AS autor_apellido, categorias.nombre AS categoria
              FROM libros
...
<body>
    <div class="container">
        ...
        <form action="index.php" method="get" style="width: 100%; max-width: 30rem" class="my-5">
                            ...
                            <div class="card box-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <strong>Descripción:</strong> <?= substr($book['descripcion'], 0, 100) . (strlen($book['descripcion']) > 100 ? "..." : "") ?>
                                    </p>
